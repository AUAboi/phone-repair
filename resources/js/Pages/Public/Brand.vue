...
<template>
  ...
  <section class="bg-blue-50 pb-9 pt-16">
    <div class="flex flex-col-reverse sm:grid sm:grid-cols-2 items-center px-4 max-w-4xl mx-auto">
      <div>

        <h3 class="text-red-600 font-semibold text-4xl sm:text-5xl text-center sm:text-left">{{ brand.name }} Repairs</h3>
  ...
  <section class="px-2 py-4">
    <h4 class="text-red-600 font-semibold text-4xl sm:text-6xl text-center my-8">Choose your device</h4>
