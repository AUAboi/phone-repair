<template>
  <div class="container-fluid">
    <div class="max-w-[985px] mx-auto">
      <div
        class="product-dtls-navtab border-y border-bdr-clr dark:border-bdr-clr-drk"
      >
        <ul
          id="user-nav-tabs"
      ...
      <div
        id="content"
        class="mt-5 sm:mt-8 lg:mt-12 mx-0 sm:mr-5 md:mr-8 lg:mr-12"
      >
        <div v-if="activeTab === 1">
          <div class="uncss" v-html="product.body"></div>
        </div>
        <div v-if="activeTab === 2">
          ...
          >
            <div v-for="(item, index) in venderInfo" :key="index">
              <span class="text-primary sm:text-lg leading-none block"
                >Shop Name</span
              >
              <h4
                class="font-medium mt-2 sm:mt-3 text-xl sm:text-2xl leading-none"
              >
                {{ item.name }}
              </h4>
        ...
        <div v-if="activeTab === 3">
          <div
            class="max-w-[905px] flex items-start xl:justify-between gap-8 flex-wrap"
          >
            <div
            ...
            >
              ...
              <ul class="flex items-center gap-2 mt-4 sm:mt-6">
                <li>
                  <i class="fa-solid fa-star text-[#EE9818] text-[14px]"></i>
                </li>
                <li>
                  <i class="fa-solid fa-star text-[#EE9818] text-[14px]"></i>
                </li>
                ...
                <li>
                  <i class="fa-solid fa-star text-slate-300 text-[14px]"></i>
                </li>
                <li class="dark:text-gray-100">( 125 )</li>
              </ul>
              <h6 class="font-semibold leading-none mt-[10px]">
                {{ item.name }}
              </h6>
        ...
        <div v-if="activeTab === 4">
          ...
          >
            <h4 class="text-xl sm:text-2xl leading-none font-medium">
              {{ item.title }}
            </h4>
            <p class="sm:text-lg mt-3">{{ item.desc }}</p>
          </div>
