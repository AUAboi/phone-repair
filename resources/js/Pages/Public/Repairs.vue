...
<template>
  ...
  <section class="bg-red-100 py-8">
    <div class="flex flex-col-reverse sm:grid sm:grid-cols-2 items-center px-4 max-w-4xl mx-auto gap-6">
      <div>
        <h3 class="text-red-600 font-semibold text-4xl text-center sm:text-left"> Repairs</h3>
