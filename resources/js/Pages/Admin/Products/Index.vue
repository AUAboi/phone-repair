  ...
  <div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="flex items-center gap-4 md:gap-0 justify-between">
        ...
        <Link :href="route('products.create')" as="button" class="btn--primary">Create <span class="hidden md:inline">
          Product</span></Link>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg mx-2 md:mx-0">
        <div class=" text-gray-900 dark:text-gray-100 overflow-x-auto">
          <DataTable :table-data="products.data" :labels="labels" resource-route="products.edit" />
        </div>
