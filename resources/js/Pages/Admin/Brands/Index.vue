...
watchThrottled(
  form,
  () => {
    router.get(route("brands.index"), form, {
      preserveState: true,
      preserveScroll: true,
    });
  },
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="flex items-center gap-4 md:gap-0 justify-between">
        <SearchBox
          ...
          @reset="reset"
        />
        <Link :href="route('brands.create')" as="button" class="btn--primary"
          >Create <span class="hidden md:inline"> Brand</span></Link
        >
      </div>
      ...
      >
        <div class="text-gray-900 dark:text-gray-100">
          <DataTable
            :table-data="brands.data"
            :labels="labels"
            resource-route="brands.edit"
          />
        </div>
