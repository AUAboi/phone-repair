...
<template>
  <div class="flex items-center gap-4 sm:gap-6">
    ...
    >
      <h4
        class="font-medium leading-none dark:text-white mb-4 text-xl md:text-2xl"
      >
        Wishlist
      </h4>
      <div>
        <div class="pr-4 md:pr-5 wishlist-item">
          ...
          >
            ...
            <div>
              ...
              <h6 class="text-base md:text-lg font-semibold leading-none mt-3">
                Modern Sofa Set
              </h6>
            </div>
            <div
            ...
            >
              <svg
                class="fill-current text-title dark:text-white duration-300 group-hover:text-white"
                width="10"
                height="10"
                viewBox="0 0 10 10"
                fill="none"
    ...
    >
      <h4 class="font-medium leading-none mb-4 text-xl md:text-2xl">
        Cart List
      </h4>
      <div>
        <div class="hdr-cart-item">
            ...
            <div>
              ...
              >
                <router-link to="/product-details"
                  >Classic Chair with Vase</router-link
                >
              </h6>
              <div class="inc-dec flex items-center gap-2 mt-4">
                <div
          ...
          >
            ...
            <div>
              ...
              >
                <router-link to="/product-details"
                  >Luxury Hanging Lamp</router-link
                >
              </h6>
              <div class="inc-dec flex items-center gap-2 mt-4">
                <div
          ...
          >
            ...
            <div>
              ...
              >
                <router-link to="/product-details"
                  >Premium Quality Vase</router-link
                >
              </h6>
              <div class="inc-dec flex items-center gap-2 mt-4">
                <div
