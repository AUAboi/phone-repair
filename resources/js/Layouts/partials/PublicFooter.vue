  ...
  <footer class="text-gray-400 bg-neutral-900 body-font">
    ...
    >
      ...
      >
        <div
          ...
          v-for="(chunk, index) in chunk($page.props.navigation.devices, 4)"
          :key="index"
        >
          <h2
            class="title-font font-medium text-red-500 tracking-widest text-sm mb-3"
          >
            Repair Device
          </h2>
        ...
        <div
          class="lg:w-1/4 md:w-1/2 w-full px-4"
          v-for="(chunk, index) in chunk($page.props.navigation.products, 4)"
          :key="index"
        >
          <h2
            class="title-font font-medium text-red-500 tracking-widest text-sm mb-3"
    ...
    <div class="bg-black bg-opacity-75">
      ...
      >
        ...
        >
          <a
            href="https://www.facebook.com/fonemartBR"
            target="_blank"
            class="text-gray-400"
          >
            <svg
