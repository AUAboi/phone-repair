    ...
    <transition leave-active-class="duration-200">
      ...
      >
        ...
        >
          <div
            v-show="show"
            class="mb-6 bg-white dark:bg-gray-800 rounded-lg overflow-y-auto shadow-xl transform transition-all sm:w-full sm:mx-auto"
            :class="[maxHeightClass, maxWidthClass]"
          >
            <slot v-if="show" />
          </div>
        </transition>
